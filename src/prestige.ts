...
export function prestige(s:GameState){
 ...
 const reset={...s,credits:0,data:0,hardware:1,hardwareCounts:base.hardwareCounts,classUpgrades:[],level:0,qualityLevel:0,efficiencyLevel:0,training:0,activeTraining:null,runRecyclingRewards:[],researchQueue:null,feedback:base.feedback,runCreditsEarned:0,totalINTEarned:s.totalINTEarned+gain,unspentINT:s.unspentINT+gain,prestigeEntitlementClaimed:s.prestigeEntitlementClaimed+gain,prestigeCount:s.prestigeCount+1,onboarding:{...s.onboarding,completed:[...new Set([...s.onboarding.completed,'first-prestige'])]}};
