import { BALANCE, newGame, BreakthroughId, canPrestige, GameState, newINT, PrestigeUpgradeId, prestigeUpgradeCost, upgradeLevel, exactEconomyValue, MAX_ECONOMY_VALUE } from './economy';
...
export function buyNode(s:GameState,id:PrestigeUpgradeId,_legacyTier?:number){
 ...
 return {...s,unspentINT:unspent.toNumber(MAX_ECONOMY_VALUE),spentINT:spent.toNumber(MAX_ECONOMY_VALUE),exactEconomy:{...s.exactEconomy,unspentINT:unspent.toJSON(),spentINT:spent.toJSON()},nodes:[...s.nodes,id]};
}
