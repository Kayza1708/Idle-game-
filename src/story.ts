...
export const dialogues:Record<string,Dialogue>={
 ...
 'prologue-aura':{speaker:'Mira',text:()=> 'Das ist AURA. Im Moment läuft ihr ganzes Modell auf ziemlich bescheidener Hardware.'},
 'prologue-funding':{speaker:'Mira',text:()=> 'Die Förderung ist weg. Wenn wir das Labor selbst finanzieren, können wir AURA weiterentwickeln und echte Forschungsfragen angehen.'},
 ...
 'tutorial-tap':{speaker:'Mira',text:s=>`Gib AURA einen ersten Impuls: Tippe einmal auf die Laborillustration. Der Impuls bringt aktuell ${tapCredits(s).toLocaleString('de-DE',{maximumFractionDigits:2})} Credits.`},
 ...
 'tutorial-training':{speaker:'Mira',text:s=>`Als Nächstes trainieren wir AURA. Qualität steigert Nutzerwert und Taps; Effizienz bringt mehr Nutzer je Hardware. Der nächste Lauf kostet ab ${Math.min(trainingCost(s,'quality'),trainingCost(s,'efficiency')).toLocaleString('de-DE')} Credits plus Daten.`},
 'first-training':{speaker:'Mira',text:s=>`Training abgeschlossen. AURA steht jetzt bei Qualität ${s.qualityLevel} und Effizienz ${s.efficiencyLevel}.`},
