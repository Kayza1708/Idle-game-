...
export type TelemetryEventType = 'hardware-purchase'|'hardware-milestone'|'training-start'|'training-complete'|'research-start'|'research-complete'|'experiment-complete'|'breakthrough'|'item-create'|'item-craft'|'component-found'|'item-equip'|'item-upgrade'|'item-lock'|'item-salvage'|'achievement'|'mission-claim'|'prestige';
